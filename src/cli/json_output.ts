 ...
 * nine verbs must spell one flag identically, and nine independent
 * `addArgument` calls are nine chances to disagree about the help text, the
 ...
 * `--help` on a cp932 console from all nine verbs at once.
 */
...
/** The flag's help text, declared once so nine verbs cannot disagree about it. */
